...
clients to perceive our system as a single conherent unit, but at the same time
...
have different ideas of what the world looks like. Making a distributed system
behave like a conherent unit in face of these failures can be a challenge, and
that's why we need a consensus algorithm, like `Raft`, that gives us some
guarantees about the properties that we can expect of this system.
